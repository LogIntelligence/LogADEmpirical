...
from logadempirical.models.PLELog.data.Instance import *
from logadempirical.models.PLELog.data.TensorInstances import *
from logadempirical.models.PLELog.data.Vocab import *
...
def load_from_structured(logID2Temp, fixLength, ratio=[7, 1, 2], dataset="BGL", output_dir=""):
    from logadempirical.models.PLELog.data.Sample import load_features, sliding_window, sliding_window_test
    print(output_dir)
