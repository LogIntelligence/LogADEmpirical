...
def process_dataset(data_dir, output_dir, log_file, dataset_name, window_type, window_size, step_size, train_size,
                    is_chronological=False, session_type="entry"):
    """
    ...
    # Transformation #
    ##################
    logging.info("Loading", f'{data_dir}/{log_file}_structured.csv')
    ...
    if window_type == "sliding":
        ...
        if not is_chronological:
            window_df = sliding(df[["Label", "EventId", "EventTemplate", "Content"]],
        ...
        if dataset_name == "hdfs":
            ...
            logging.info("label dict size: {}".format(len(label_dict)))
